        ...
        while attempt <= 5:
            try:
                order = Order.objects.get(
                    ...
                    street_address1_name__iexact=shipping_details.line1,
                    street_address2_name__iexact=shipping_details.line2,
        ...
        if order_exists:
            ...
            try:
                order = Order.objects.create(
                    ...
                    street_address1_name=shipping_details.line1,
                    street_address2_name=shipping_details.line2,
