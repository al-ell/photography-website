"""
Django settings for gl_photography project.
...
if 'DEVELOPMENT' in os.environ:
    ...
    DEFAULT_FROM_EMAIL = 'hello@gwilymllywelyn.com'
    DEFAULT_TO_EMAIL = 'hello@gwilymllywelyn.com'
else:
...
WSGI_APPLICATION = 'gl_photography.wsgi.application'
...
if 'USE_AWS' in os.environ:
    ...
    AWS_S3_OBJECT_PARAMETERS = {
        'Expires': 'Thu, 31 Dec 2099 18:00:00 GMT',
        'CacheControl': 'max-age=94608000'
    }
    # Bucket configuration
    AWS_STORAGE_BUCKET_NAME = 'gl-photography'
...
# to prevent 500 errors during login
